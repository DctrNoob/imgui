...
bool ImGui::InputText(const char* label, ab::label_t* str,
...
bool ImGui::InputTextMultiline(const char* label, ab::label_t* str,
...
bool ImGui::InputTextWithHint(const char* label, const char* hint,
                              ab::label_t* str, ImGuiInputTextFlags flags,
                              ImGuiInputTextCallback callback,
                              void* user_data) {
  IM_ASSERT((flags & ImGuiInputTextFlags_CallbackResize) == 0);
  flags |= ImGuiInputTextFlags_CallbackResize;
